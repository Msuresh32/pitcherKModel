"""Fetch PITCHER OUTS lines at the early open (T-12h, fallback T-6h), 2025+2026.
...
Output: data/odds/historical/pitcher_outs_open_2025_2026.csv
...
OUTPUT = Path("data/odds/historical/pitcher_outs_open_2025_2026.csv")
